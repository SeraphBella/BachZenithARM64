...
void GameControllers::TryOpenSDLControllers() {
    ...
    LOG_INFO(Input,
             "Z4.39 SDL ENUM call={} count={} ptr={} error='{}'",
             z439_call, controller_count,
             static_cast<const void*>(new_joysticks),
             SDL_GetError());

    for (int z439_i = 0; z439_i < controller_count; ++z439_i) {
        const SDL_JoystickID z439_id = new_joysticks[z439_i];
        const char* z439_name = SDL_GetGamepadNameForID(z439_id);

        LOG_INFO(Input,
                 "Z4.39 SDL PAD index={} id={} name='{}'",
                 z439_i, z439_id,
                 z439_name ? z439_name : "<null>");
    }
