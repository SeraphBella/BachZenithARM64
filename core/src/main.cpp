...
#ifdef ENABLE_BACHATA_RUNTIME
    // ZENITH ARM64 LINUX:
    // Do not start Bachata's Android remote-controller transport here.
    // Linux input remains handled by the normal SDL controller path.
    LOG_INFO(Debug, "BACHATA_INPUT: remote input transport disabled; using native Linux SDL input");
